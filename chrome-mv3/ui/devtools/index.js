(function () {
    ...
    const DEVTOOLS_DOCS_URL = 'https://github.com/darkreader/darkreader/blob/master/CONTRIBUTING.md';
    ...
    function Body({ data, tab, actions }) {
        ...
        const dialog = context && context.store.isDialogVisible ? (m(MessageBox, { caption: "Are you sure you want to remove current changes? You cannot restore them later.", onOK: reset, onCancel: hideDialog })) : null;
        function reset() {
            context.store.isDialogVisible = false;
            wrapper.reset();
            setState({ errorText: null });
        ...
        return (m("body", null,
            ...
            m("textarea", { id: "editor", onrender: onTextRender, spellcheck: "false", autocorrect: "off", autocomplete: "off", autocapitalize: "off" }),
            m("label", { id: "error-text" }, state.errorText),
            m("div", { id: "buttons" },
                m(Button, { onclick: showDialog },
                    "Reset changes",
                    dialog),
