(function () {
    ...
    function Body({ data, tab, actions }) {
        ...
        return (m("body", null,
            ...
            m("textarea", { id: "editor", native: true, placeholder: placeholderText, onrender: onTextRender, spellcheck: "false", autocorrect: "off", autocomplete: "off", autocapitalize: "off" }),
            m("div", { id: "buttons" },
